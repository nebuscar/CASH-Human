...
print(p)
ggsave("./fig/Fig02.Myeloid/Fig2C.Pct_bar_plot_Myeloid.pdf", plot = p, width = 12, height = 6, dpi = 300)
ggsave("./fig/Fig02.Myeloid/Fig2C.Pct_bar_plot_Myeloid.png", plot = p, width = 12, height = 6, dpi = 300)