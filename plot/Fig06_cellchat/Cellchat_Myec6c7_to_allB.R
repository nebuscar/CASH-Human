...
dir_for_cellchat <- "./data/cellchat/cellchat_Myeloidc3c6_to_allB.rds"
dir_for_cellchat_CASH <- "./data/cellchat/cellchat_Myeloidc3c6_to_allB_CASH.rds"
...
meta_B <- subset(meta, major_celltype %in% "B")
meta_Myeloid <- subset(meta, sub_celltype %in% c("c06_ Macrophage_", "c07_ Macrophage_ MARCO"))
meta_merge <- rbind(meta_B, meta_Myeloid)
...
# saveRDS(cellchat, "./data/cellchat/cellchat_Myeloidc3c6_to_allB.rds")
saveRDS(cellchat, "./data/cellchat/cellchat_Myeloidc3c6_to_allB_CASH.rds")
...
p <- netVisual_bubble(cellchat, 
                      ...
                      remove.isolate = F, 
                      sort.by.target = T) + 
  ggtitle("Cellchat_Myeloidc3c6_to_allB")
pdf("./fig/Fig06.cellchat/Cellchat_Myeloidc3c6_to_allB.pdf", width = 10, height = 10)
print(p)
dev.off()
