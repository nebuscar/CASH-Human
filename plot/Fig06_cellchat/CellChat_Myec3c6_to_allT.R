...
dir_for_cellchat <- './data/cellchat/cellchat_Myeloidc6c7_to_allT.rds'
dir_for_cellchat_CASH <- './data/cellchat/cellchat_Myeloidc6c7_to_allT_CASH.rds'
...
saveRDS(cellchat, "./data/cellchat/cellchat_Myeloidc6c7_to_allT_CASH.rds")
...
p <- netVisual_bubble(cellchat, 
                      ...
                      remove.isolate = F, 
                      sort.by.target = T) + 
  ggtitle("Cellchat_Myeloidc6c7_to_allT")
pdf("./fig/Fig06.cellchat/Cellchat_Myeloidc6c7_to_allT.pdf", width = 10, height = 10)
print(p)
dev.off()
